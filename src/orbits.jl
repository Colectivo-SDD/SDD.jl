...
"""
    drawpointorbitR2(f, x0, y0 [; preiterations, maxiterations])
...
`maxiterations::Integer`: Maximum number of iterations to calculate (after `preiterations`).
"""
function drawpointorbitR2(f::Function, x0::Real, y0::Real;
    preiterations::Integer=0, maxiterations::Integer=100)
...
"""
    drawpointssetorbitR2(f, ps [; preiterations, maxiterations])
...
function drawpointssetorbitR2(f::Function, ps::Array{Tuple{T,T},1};
    preiterations::Integer=0, maxiterations::Integer=100) where T <: Real
...
"""
    drawpointorbitC(f, z0 [; preiterations, maxiterations])
...
"""
    drawpointssetorbitC(f, ps [; preiterations, maxiterations])
...
function drawpointssetorbitC(f::Function, ps::Array{T,1};
    preiterations::Integer=0, maxiterations::Integer=100) where T <: Number
